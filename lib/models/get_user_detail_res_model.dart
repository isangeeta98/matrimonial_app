...
//
//     final getUserDetailResModel = getUserDetailResModelFromJson(jsonString);

import 'dart:convert';

GetUserDetailResModel getUserDetailResModelFromJson(String str) => GetUserDetailResModel.fromJson(json.decode(str));

String getUserDetailResModelToJson(GetUserDetailResModel data) => json.encode(data.toJson());

class GetUserDetailResModel {
  List<Joindatum>? joindata;

  GetUserDetailResModel({
    this.joindata,
  });

  factory GetUserDetailResModel.fromJson(Map<String, dynamic> json) => GetUserDetailResModel(
...
class Joindatum {
  ...
  List<Useraddressdetail>? useraddressdetails;
  ...
  factory Joindatum.fromJson(Map<String, dynamic> json) => Joindatum(
    ...
    useraddressdetails: List<Useraddressdetail>.from(json["useraddressdetails"].map((x) => Useraddressdetail.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
    ...
    "useraddressdetails": List<dynamic>.from(useraddressdetails!.map((x) => x.toJson())),
...
class Useraddressdetail {
  ...
  factory Useraddressdetail.fromJson(Map<String, dynamic> json) => Useraddressdetail(
    id: json["_id"],
