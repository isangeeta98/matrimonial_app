...
class BlockUserScreen extends StatefulWidget {
  String? genderdaat;
  BlockUserScreen({Key? key, this.genderdaat}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        body: Obx((){
          final selectedIds = shortListUserController.blockuserlistdata.value.post?.map((component) => component.bpBlockUserId).toList();
